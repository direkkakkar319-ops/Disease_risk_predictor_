...
User uploads a health report <br>
Backend validates and stores file <br>
Job is pushed to Redis queue<br>
Celery worker processes report<br>
OCR extracts text and lab values<br>
Data is normalized and structured<br>
ML model predicts risk probabilities<br>
SHAP generates explainability insights<br>
Results are stored in PostgreSQL<br>
