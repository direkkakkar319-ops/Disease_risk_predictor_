                                ...
                                <div className="flex flex-col gap-1.5 animate-slide-up relative" style={{ animationDelay: '160ms', animationFillMode: 'both' }}>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <button 
                                            ...
                                            className="absolute right-0 top-0 h-full px-3 text-brutalist-fg hover:text-brutalist-accent dark:hover:text-brutalist-accent dark:hover:text-brutalist-accent focus:outline-none transition-colors"
                                            tabIndex="-1"
                                        >
